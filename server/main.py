...
TEXT_MODEL_PATH = "models/text-model.pth"
...
text_model.load_state_dict(torch.load(TEXT_MODEL_PATH, map_location=DEVICE_TEXT))
text_model.to(DEVICE_TEXT)
text_model.eval()
